...
credit_rest = int(input('Введите остаток по кредиту: '))
food_expanses = int(input('Введите траты на еду: '))
all_expanses = credit_rest + food_expanses
salary = 200 * hours / 2 ** 3 + hours
print()
# проверка расчетов
# print('Заработок:', salary)
# print('Общие расходы:', all_expanses)
if salary >= all_expanses:
