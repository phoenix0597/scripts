...
player_num = int(input('Введите число на кубике игрока: '))
owner_num = int(input('Введите число на кубике владельца: '))
diff = player_num - owner_num
sum = player_num + owner_num
print()
if diff >= 0:
  print('Сумма:', diff, '\nИгрок платит')
else:
