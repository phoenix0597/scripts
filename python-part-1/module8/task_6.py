...
expanses = int(input('Введите расходы на проживание: '))
month_infl_percent = 3
gap_total = 0
if expanses - educational_grant > 0:
  for month in range(1, 11):
    gap_total += expanses - educational_grant
    print(str(month) + '. месяц траты', round(expanses, 2), 'не хватает', round(gap_total, 2))
    expanses *= 1 + month_infl_percent / 100
  print('Нужно попросить у родителей', round(gap_total, 2), 'рублей')
else:
  print('Нет необходимости просить деньги у кого-либо, стипендия полностью покроет ваши расходы!')
