...
debtors_number = int(input('Введите количество должников: '))
total_sum = 0
for debtor_id in range(0, debtors_number, 5):
  print('Должник с номером', debtor_id)
  debtor_sum = int(input('Сколько должны? '))
  total_sum += debtor_sum
print()
print('Общая сумма долга:', total_sum)
