...
earthVolume = 10.8321 * 10 ** 11
# print(earthVolume)
radius = float(input('\nВведите радиус случайной планеты: '))
randomPlanetVolume = 4 / 3 * math.pi * radius ** 3
ratio = 1

if earthVolume > randomPlanetVolume:
  ratio = round(earthVolume / randomPlanetVolume, 3)
  print('Объём планеты Земля больше в', ratio, 'раз')
elif earthVolume < randomPlanetVolume:
  ratio = round(randomPlanetVolume / earthVolume, 3)
  print('Объём планеты Земля меньше в', ratio, 'раз')
else:
